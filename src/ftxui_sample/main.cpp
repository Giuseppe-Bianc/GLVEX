...
// configuration step. It creates a namespace called `GLVEX`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", GLVEX::cmake::project_name, GLVEX::cmake::project_version) };
